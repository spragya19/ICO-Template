...
const Footer = () => {
  ...
  <div> <img className="w-30 text-white" src="/assets/img/f1.png" alt=""></img></div>
  <div> <img className="w-30" src="/assets/img/f2.png" alt=""></img></div>
  <div> <img className="w-30" src="/assets/img/f3.png" alt=""></img></div>
  <div> <img className="w-30" src="/assets/img/f4.png" alt=""></img></div>
  <div> <img className="w-30" src="/assets/img/f5.png" alt=""></img></div>
  <div> <img className="w-30" src="/assets/img/f1.png" alt=""></img></div>
</div>
<div class="grid grid-cols-4 mt-5 mb-4 text-center">
  <div> <img className="w-30 mx-auto" src="/assets/img/f1.png" alt=""></img></div>
  <div> <img className="w-30 mx-auto" src="/assets/img/f2.png" alt=""></img></div>
  <div> <img className="w-30 mx-auto" src="/assets/img/f3.png" alt=""></img></div>
  <div> <img className="w-30 mx-auto" src="/assets/img/f4.png" alt=""></img></div>
